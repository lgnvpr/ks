 ...
 * @author LGNV
 */
public class pnl_tab_Manager_KhachHang extends javax.swing.JPanel {

    /**
     * Creates new form tab_Manager_LoaiPhong
     */
    public pnl_tab_Manager_KhachHang() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tblKhachHang.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã Khách Hàng", "Tên khách hàng", "CMND", "Địa chỉ", "SDT", "Ngày sinh", "Giới Tính", "Mô tả"
            }
        ) {
    ...
    private void lgnvButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lgnvButton1ActionPerformed
        main.dialogFormKhachHang.addNew(true);
        main.dialogFormKhachHang.setVisible(true);
    ...
    private void tblKhachHangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblKhachHangMouseClicked
        if (evt.getClickCount() == 2) {
            ...
            main.dialogFormKhachHang.addNew(false);
            main.dialogFormKhachHang.setVisible(true);
        }
